...
?>
    ...
    <h2 class="text-center display-3 my-2">ABS-Árak Módosítása</h2>
            ...
            while($row=$stmt->fetch()){
                ...
                <tr class='table-row'>
                    ...
                    <td contenteditable='true'
                        onBlur='save(this,"nev",<?=$id?>)'
                        onClick='showEdit(this);'><?=$nev?></td>
                    <td contenteditable='true'
                        onBlur='save(this,"brutto",<?=$id?>)'
                        onClick='showEdit(this);'><?=$brutto?></td>
                    <td contenteditable='true'
                        onBlur='save(this,"netto",<?=$id?>)'
                        onClick='showEdit(this);'><?=$netto?></td>
                </tr>
            <?php }?> 
        </tbody>
    </table>

  ...
  <figcaption class="blockquote-footer">
    <cite title="Üdvözlöm!"><h5><b>T-K</b>orpusz Innova Kft.</h5></cite>
          ...
          <section>
            ...
            <section>
              <!--videok-->
              <div class="row my-5 align-items-center" id="video1">
                <div class="container2 col-lg-6 col-md-6 col-sm-12">
                  <div class="iframe-wrapper">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/jFqotd5JB-M?si=ftdiNBi6Skmph8r6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
                </div>
                <div class="container2 col-lg-6 col-md-6 col-sm-12">
                  <div class="iframe-wrapper">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/Zky6mZMicks?si=vAOAojcRKObSuDWN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                  </div>
                </div>
            </section>
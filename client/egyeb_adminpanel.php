...
?>
    ...
    <h2 class="text-center display-3 my-2">Egyéb-Árak Módosítása</h2>
            ...
            while($row=$stmt->fetch()){
                ...
                <tr class='table-row'>
                    ...
                    <td contenteditable='true'
                        onBlur='save3(this,"nev",<?=$id?>)'
                        onClick='showEdit3(this);'><?=$nev?></td>
                    <td contenteditable='true'
                        onBlur='save3(this,"brutto",<?=$id?>)'
                        onClick='showEdit3(this);'><?=$brutto?></td>
                    <td contenteditable='true'
                        onBlur='save3(this,"netto",<?=$id?>)'
                        onClick='showEdit3(this);'><?=$netto?></td>
                </tr>
            <?php }?> 
        </tbody>
    </table>
